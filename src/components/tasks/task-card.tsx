...
export function TaskCard({ task, categories, projects, onEdit, onDelete }: TaskCardProps) {
            ...
            <div className='flex items-center space-x-1'>
              ...
              <span className='text-xs'>
                {(() => {
                  ...
                  return project ? (language === 'no' && project.name_nb ? project.name_nb : project.name) : 'Unknown Project';
                })()}
              </span>
            </div>
          )}
            ...
            <div className='flex items-center space-x-1 flex-wrap'>
              ...
              <div className='flex flex-wrap gap-1'>
                {task.category.map((categoryId) => {
                  ...
                  return (
                    <Badge key={categoryId} variant='secondary' className='text-xs px-1 py-0'>
