    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[80vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            Manage variables that can be used in your requests using {"{{"}}{"variable_name"}{"}}"}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 my-4">
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm text-blue-800 dark:text-blue-200">
              ...
              <p>Use {"{{"}}{"variable_name"}{"}}"}  in URLs, headers, or request body. Example:</p>
            ...
            {localVariables.map((variable, index) => (
              <div key={index} className="flex items-center gap-2 p-3 border rounded-lg">
                <Switch
                  ...
                  onCheckedChange={(checked) => updateVariable(index, "enabled", checked)}
                />
                <Input
