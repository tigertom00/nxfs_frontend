...
export function MaterialDetailModal({
  ...
  const confirmFavoriteToggle = () => {
    onToggleFavorite?.(material);
    setShowFavoriteConfirm(false);
    toast({
      title: material.favorites
        ? 'Removed from favorites'
        : 'Added to favorites',
      description: material.favorites
        ? 'Material removed from your favorites'
        : 'Material added to your favorites',
    });
  };
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-2xl max-h-[70vh] overflow-y-auto">
          <DialogHeader>
            ...
            {/* Add to Job Button - Moved to top */}
            {onSelect && (
              <Button
                onClick={handleSelectClick}
                className="w-full mt-4 bg-yellow-gradient hover:bg-yellow-gradient-hover text-foreground"
              >
                  ...
                  <div className="space-y-2">
                    ...
                    {material.fdv && (
                      <Button
                        ...
                        className="w-full justify-start"
                        onClick={() =>
                          material.fdv && window.open(material.fdv, '_blank')
                        }
                      >
                        <ExternalLink className="h-4 w-4 mr-2" />
                        FDV Document
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {material?.favorites
                ? 'This material will be removed from your favorites list.'
                : 'This material will be added to your favorites for quick access.'}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={confirmFavoriteToggle}>
              {material?.favorites ? 'Remove' : 'Add'}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
